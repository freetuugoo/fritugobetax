...
<body>
    <div id="page-wrapper">
        ...
        <section id="content">
            <div class="container">
                <div id="main" class="faqs style1" style="padding-top: 20px;">
                    <div class="row">
                        <div class="col-sm-4 col-md-3">
                            <div class="travelo-box search-questions">
                                ...
                                <form>
                                    <div class="with-icon full-width">
                                        <input type="text" class="input-text full-width" placeholder="type question here" style="border-radius:30px;">
                                        <button class="icon green-bg white-color" style="border-top-right-radius:30px;border-bottom-right-radius:30px;"><i class="soap-icon-search"></i></button>
                                    </div>
                                </form>
                            </div>
                            <div class="travelo-box filters-container faq-topics">
                                ...
                                <ul class="triangle filters-option">
                                    ...
                                    <li class="active"><a href="#">Itineraries</a></li>
                                ...
                                <div class="toggle-container">
                                    <div class="panel style1">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#tgg1" class="collapsed">How to make an itinerary?</a>
                                        </h4>
                                    ...
                                    <div class="panel style1">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#tgg2">How do I edit my itinerary? </a>
                                        </h4>
                                    ...
                                    <div class="panel style1">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#tgg3" class="collapsed">How can I edit others itinerary? </a>
                                        </h4>
                                    ...
                                    <div class="panel style1">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#tgg4" class="collapsed">How do I list multiple itineraries? </a>
                                        </h4>
                                    ...
                                    <div class="panel style1">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#tgg5" class="collapsed">How do I download, print, or share my itinerary? </a>
                                        </h4>
                                    ...
                                    <div class="panel style1">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#tgg6" class="collapsed">How do I book any flight or hotel in itinerary? </a>
                                        </h4>
                                    ...
                                    <div class="panel style1">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#tgg7" class="collapsed">Why was my itinerary deleted? </a>
                                        </h4>
                                    ...
                                    <div class="panel style1">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#tgg8" class="collapsed">How do I turn off or delete my itinerary? </a>
                                        </h4>
