                        ...
                        <table style="text-align:center; border:0px solid #000; width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td style="color:#636363; font-size:13px; font-weight:500; padding: 10px 10px 0px 10px; text-align:right;">
                                        ...
                                        <a href="#" class="soap-popupbox"><img src="images/download_icon.png" style="width:7%; padding-right:5px;">download</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        <a href="#" class="soap-popupbox"><img src="images/print_icon.png" style="width:7%; padding-right:5px;">print</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        <a href="#" class="soap-popupbox"><img src="images/share_icon.png" style="width:7%; padding-right:5px;">share</a>
                                    </td>
                                </tr>
                            </table>
                    </div>                    
                            ...
                            <div style="height:400px;width:290px;overflow:auto;color:white;scrollbar-base-color:gold;"><br>
                                            ...
                                            <td style="padding-top:10px">
                                                <div style="background-color:#fff; border-radius:4px; height:55px; width:270px;">
                                                    <div style="padding: 11px 10px 10px 10px; text-align: left;">
                                                        <img src="images/vaticangarden_sq.jpg" style="width:36px; border-radius:1000px;">&nbsp&nbsp&nbsp&nbsp
                                        ...
                                        <tr>
                                            <td style="padding-top:0px">
                                                <div style="background-color:#fff; border-radius:4px; height:55px; width:270px;">
                                                    <div style="padding: 11px 10px 10px 10px; text-align: left;">
                                                        <img src="images/thesistinechapel_sq.jpg" style="width:36px; border-radius:1000px;">&nbsp&nbsp&nbsp&nbsp
                                                        <a style="font-size:16px; color:#636363; font-weight: 500; padding-top:10px;" class="soap-icon-departure">&nbsp&nbspThe Sistine Chapel</a><br>
                                        ...
                                        <tr>
                                            <td style="padding-top:0px">
                                                <div style="background-color:#fff; border-radius:4px; height:55px; width:270px;">
                                                    <div style="padding: 11px 10px 10px 10px; text-align: left;">
                                                        <img src="images/vaticanmuseum_sq.jpeg" style="width:36px; border-radius:1000px;">&nbsp&nbsp&nbsp&nbsp
                                                        <a style="font-size:16px; color:#636363; font-weight: 500; padding-top:10px;" class="soap-icon-departure">&nbsp&nbspVatican Museums</a><br>
                                        ...
                                        <tr>
                                            <td style="padding-top:0px">
                                                <div style="background-color:#fff; border-radius:4px; height:55px; width:270px;">
                                                    <div style="padding: 11px 10px 10px 10px; text-align: left;">
                                                        <img src="images/stpetersbasilica_sq.jpg" style="width:36px; border-radius:1000px;">&nbsp&nbsp&nbsp&nbsp
                                                        <a style="font-size:16px; color:#636363; font-weight: 500; padding-top:10px;" class="soap-icon-departure">&nbsp&nbspSt.Peter's Basilica</a><br>
                                        ...
                                        <tr>
                                            <td style="padding-top:0px">
                                                <div style="background-color:#fff; border-radius:4px; height:55px; width:270px;">
                                                    <div style="padding: 11px 10px 10px 10px; text-align: left;">
                                                        <img src="images/stpeterssquare_sq.jpg" style="width:36px; border-radius:1000px;">&nbsp&nbsp&nbsp&nbsp
                                                        <a style="font-size:16px; color:#636363; font-weight: 500; padding-top:10px;" class="soap-icon-departure">&nbsp&nbspSt. Peter's Square</a><br>
                                        ...
                                        <tr>
                                            <td style="padding-top:0px">
                                                <div style="background-color:#fff; border-radius:30px; height:36px; width:160px; margin-left:10px;">
                                                    ...
                                                    <div style="padding: 0px 10px 10px 0px; text-align: left;">
                                                       <img src="images/lapergola.jpg" style="width:36px; border-radius:1000px;">&nbsp&nbsp&nbsp&nbsp
                                                        <a style="font-size:13px; color:#636363; font-weight: 500; padding-top:10px;" class="soap-icon-breakfast">&nbsp&nbspLa Pergola</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding-top:0px">
                                                <div style="background-color:#fff; border-radius:4px; height:55px; width:270px;">
                                                    <div style="padding: 11px 10px 10px 10px; text-align: left;">
                                                        <img src="images/castelsantangelo_sq.jpg" style="width:36px; border-radius:1000px;">&nbsp&nbsp&nbsp&nbsp
                                                        <a style="font-size:16px; color:#636363; font-weight: 500; padding-top:10px;" class="soap-icon-departure">&nbsp&nbspCastel Sant'Angelo</a><br>
                ...
                <div class="container">
                    <div style="border-style: solid; border:1px; border-color:#222; padding: 10px 70px 30px 60px; ">
                        <div style="border-style: solid; border:1px; border-color:#222; text-align:left; ">
                                            ...
                                            <a href="#" style="background-color:#19285f; color:#fff; padding: 7px 14px 7px 14px; border-radius:30px; font-size:12px; font-weight:700;">Day 1</a>
                                            &nbsp
                    ...
                    <div style="border-style: solid; border:0px solid #fff; border-color:#222; background-color: #fff; padding: 0px 0px 0px 20px;  border-radius:8px; margin-left:30px; width:700px;">
                        <table style="text-align:center; border:0px solid #000;">
                                    <tr>
                                        <th rowspan="3" width="90px"><img src="images/piccolobuco_sq.jpg" style="border-radius:1000px;" width="90px;"></th>
                                        <th colspan="2" style="color:#19285f; font-size:16px; font-weight:500; padding: 10px 10px 10px 20px; text-align:left;">
                                        Piccolo Buco<br>
                                        <img src="images/stars.png" style="width:10%;"></th>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="color:#636363; font-size:13px; font-weight:400; padding: 10px 10px 10px 20px; text-align:left;">00120 Vatican City<a href="#" style="color:#625f93; font-size:12px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp show direction</a></td>
                                        <td style="color:#636363; font-size:13px; font-weight:400; padding: 10px 30px 10px 20px; text-align:right;"><a href="#">remove</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#">change</a></td>
                                    </tr>
                        </table>
                    </div>
                    <div style="border-style: solid; border:0px solid #fff; border-color:#222; padding: 0px 0px 0px 40px; margin-left:50px;">
                    ...
                    <div style="border-style: solid; border:0px solid #fff; border-color:#222; background-color: #fff; padding: 0px 0px 0px 20px;  border-radius:8px; margin-left:30px; width:700px;">
                        <table style="text-align:center; border:0px solid #000;">
                                    <tr>
                                        <th rowspan="3" width="90px"><img src="images/lapergola.jpg" style="border-radius:1000px;" width="90px;"></th>
                                        <th colspan="2" style="color:#19285f; font-size:16px; font-weight:500; padding: 10px 10px 10px 20px; text-align:left;">
                                        La Pergola<br>
                                        <img src="images/stars.png" style="width:10%;"></th>
                                    </tr>
                    ...
                    <div style="background-color: #fff; padding: 0px 0px 0px 10px; border-top-left-radius:8px; border-top-right-radius:8px;">
                        <table style="text-align:center; border:0px solid #000; width:100%;">
                                    <tr>
                                        <th rowspan="3" width="300px"><img src="images/castel.jpg" width="300px;" style="padding-top:10px;"></th>
                                        <th colspan="2" style="color:#19285f; font-size:16px; font-weight:500; padding: 10px 10px 10px 20px; text-align:left;">
